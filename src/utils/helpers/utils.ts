...
export function getGatewayContractAddress(network = ""): string | undefined {
  return {
    ...
    Ethereum: "0x16c9C78Dbb224889E3e2ADef991C8c4438ea797B",
    ...
    "Optimism Ethereum": "0xD293fCd3dBc025603911853d893A4724CF9f70a0",
    Scroll: "0x663C5BfE7d44bA946C2dd4b2D1Cf9580319F9338",
    Celo: "0xF418217E3f81092eF44b81C5C8336e6A6fDB0E4b",
    "Asset Chain": "0xff0E00E0110C1FBb5315D276243497b66D3a4d8a",
    Tron: "THyFP5ST9YyLZn6EzjKjFhZti6aKPgEXNU",
  }[network];
}
